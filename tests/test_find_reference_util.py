...
@raises(SystemExit)
def test_parse_find_reference_args_error1():
...
@raises(SystemExit)
def test_parse_find_reference_args_error2():
...
@raises(SystemExit)    
def test_parse_find_reference_args_error3():
...
@raises(SystemExit)    
def test_parse_find_reference_args_error4():
