...
gcc -x c++-header -c src/precompile.h -o precompile.h.gch -Isrc/ -I/abs/src -D_LINUX_ -Wall -Wno-sign-compare -Wno-unused -g -Wno-deprecated -Wno-reorder -Winvalid-pch
    """
    ...
    expected_cdb = [{
        ...
        "command": "clang++ -x c++-header -c -o precompile.h.gch"
            " -I/path/to/src/src/ -I/abs/src -D_LINUX_ -Wall -Wno-sign-compare"
            " -Wno-unused -g -Wno-deprecated -Wno-reorder -Winvalid-pch",
